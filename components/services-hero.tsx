    ...
    <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
          We offer comprehensive web development solutions that combine cutting-edge technology with exceptional design.
          From concept to deployment, we deliver results that exceed expectations.
        </p>
